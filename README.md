...
![Static Badge](https://img.shields.io/badge/node.js-grey?logo=nodedotjs) ![GitHub stars](https://img.shields.io/github/stars/arceus-am3/inanime?logo=github)
![GitHub forks](https://img.shields.io/github/forks/arceus-am3/inanime?logo=github)
...
```bash
$ git clone https://github.com/arceus-am3/inanime.git
$ cd anime-api
$ npm install
```

2. Refer the [.env.example](https://github.com/arceus-am3/inanime/blob/main/.env.example) file to setup `.env` file
...
[![Deploy to Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https://github.com/arceus-am3/inanime)

### Render

Host your own instance of anime-api on Render.

[![Deploy to Render](https://render.com/images/deploy-to-render-button.svg)](https://render.com/deploy?repo=https://github.com/arceus-am3/inanime)
...
| :-------: | :------------: | :-------: | :---------: | :---------: | :-----: |
|   `id`    |    `query`     |  string   |  anime-id   |   Yes âœ”ï¸    |   --    |
...
| Parameter  | Parameter-Type | Data-Type | Description | Mandatory ? | Default |
| :--------: | :------------: | :-------: | :---------: | :---------: | :-----: |
| `category` |     `path`     | `string`  | `Category`  |   Yes âœ”ï¸    |   --    |
|   `page`   |    `query`     | `number`  | `Page-no.`  |    No âŒ    |   `1`   |
...
| :-------: | :------------: | :------: | :---------: | :---------: | :-----: |
| `keyword` |    `query`     | `string` |  `keyword`  |   Yes âœ”ï¸    |   --    |
...
| Parameter  | Parameter-Type | Data-Type | Description                                                  | Mandatory ? |   Default   |
| :--------: | :------------: | :-------: | :----------------------------------------------------------- | :---------: | :---------: |
|   `type`   |    `query`     |  string   | Type of anime (e.g., `movie`, `tv`, etc.)                    |    No âŒ    |    `ALL`    |
|  `status`  |    `query`     |  string   | Status of anime (e.g., `finished`, `currently_airing`, etc.) |    No âŒ    |    `ALL`    |
|  `rated`   |    `query`     |  string   | Rating of anime (e.g., `G`, `PG`, etc.)                      |    No âŒ    |    `ALL`    |
|  `score`   |    `query`     |  string   | Score rating (e.g., `1` to `10`)                             |    No âŒ    |    `ALL`    |
|  `season`  |    `query`     |  string   | Season of anime (e.g., `spring`, `summer`, etc.)             |    No âŒ    |    `ALL`    |
| `language` |    `query`     |  string   | Language of anime (e.g., `sub`, `dub`)                       |    No âŒ    |    `ALL`    |
|  `genres`  |    `query`     |  string   | Comma-separated list of genres (e.g., `action, comedy`)      |    No âŒ    |    `ALL`    |
|   `sort`   |    `query`     |  string   | Sorting method (e.g., `default`, `score`, etc.)              |    No âŒ    |  `DEFAULT`  |
|   `page`   |    `query`     |  number   | Page number for pagination                                   |    No âŒ    |     `1`     |
|    `sy`    |    `query`     |  number   | Start year                                                   |    No âŒ    | `undefined` |
|    `sm`    |    `query`     |  number   | Start month                                                  |    No âŒ    | `undefined` |
|    `sd`    |    `query`     |  number   | Start day                                                    |    No âŒ    | `undefined` |
|    `ey`    |    `query`     |  number   | End year                                                     |    No âŒ    | `undefined` |
|    `em`    |    `query`     |  number   | End month                                                    |    No âŒ    | `undefined` |
|    `ed`    |    `query`     |  number   | End day                                                      |    No âŒ    | `undefined` |
| `keyword`  |    `query`     |  string   | Search keyword                                               |    No âŒ    | `undefined` |
...
| :------------: | :-------: | :---------: | :---------: | :-----: |
|    `param`     |  string   |  anime-id   |   Yes âœ”ï¸    |   --    |
...
| Parameter | Parameter-Type | Data-Type | Description | Mandatory ? | Default |
| :-------: | :------------: | :-------: | :---------: | :---------: | :-----: |
|  `date`   |     query      |  string   |    date     |   Yes âœ”ï¸    |   --    |
...
| Parameter | Parameter-Type | Data-Type | Description | Mandatory ? | Default |
| :-------: | :------------: | :-------: | :---------: | :---------: | :-----: |
|   `id`    |     param      |  string   |  anime-id   |   Yes âœ”ï¸    |   --    |
...
| :----------------------: | :------------: | :------: | :---------: | :-----: |
| `id` , `server` , `type` |    `query`     | `string` |   Yes âœ”ï¸    |   --    |
...
| Parameter-Type | Data-Type | Description | Mandatory ? | Default |
| :------------: | :-------: | :---------: | :---------: | :-----: |
|    `params`    | `string`  |  `keyword`  |   Yes âœ”ï¸    |   --    |
...
<p align="center" style="text-decoration: none;">Made by <a href="https://github.com/arceus-am3" tarGET="_blank">JustAnime 
</a>ðŸ«°</p>
